...
This module creates the util classes AutoLock which is a helper class created
to safely acquire and release the lock when used with the "with" keyword.

This module creates the DoubleBuffer object type which helps to thread-safely read
and write from the buffer.
"""
...
class AutoLock:
    """Helper class created to safely acquire and release the lock.
    """
    def __init__(self, lock):
        """Create the AutoLock object.
    ...
    def __enter__(self):
        """Triggered on entry to the "with" section. Acquire lock.
    ...
    def __exit__(self, exc_type, exc_value, traceback):
        """Triggered when exiting the "with" section. Release lock.
        """
        self.lock.release()
